...
export default function EditorPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-bg-dark text-white flex flex-col items-center justify-center gap-4">
        <RefreshCw className="w-10 h-10 text-purple animate-spin" />
        <p className="font-fredoka text-lg">Abrindo livro de colorir...</p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      {!isZenMode && (
        <footer className="md:hidden bg-bg-card border-t border-gray-800 px-4 py-3 z-30 shrink-0 select-none flex flex-col gap-3">
